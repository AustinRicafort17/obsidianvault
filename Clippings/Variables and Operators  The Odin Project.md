...
2. **Exponentiation** is done next, from right to left.
3. **Multiplication** and **Division** are done next, from left to right.
4. **Addition** and **Subtraction** are done last, from left to right.
...
2. Read up on [variables in JavaScript](https://javascript.info/variables) from JavaScript.info.
...
[Edit on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/foundations/javascript_basics/variables_and_operators.md) [Report broken link](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Ffoundations-variables-and-operators&template=broken_link.yaml&title=Variables+and+Operators%3A+%3CShort+description+of+your+suggestion%3E) [Report other issue/suggestion](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Ffoundations-variables-and-operators&template=suggestion.yaml&title=Variables+and+Operators%3A+%3CShort+description+of+your+suggestion%3E)